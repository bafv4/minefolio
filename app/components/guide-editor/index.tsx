...
export function GuideEditor({
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* ── Toolbar ── */}
      <div className="flex items-center gap-0.5 flex-wrap border rounded-t-lg px-2 py-1.5 bg-muted/30">
        <TB
          onClick={() => editor.chain().focus().toggleBold().run()}
          active={editor.isActive("bold")}
                  ...
                  <div className="flex flex-wrap gap-1 mb-2">
                    {[
                      ...
                      <button
                        ...
                        onMouseDown={(e) => {
                          e.preventDefault();
                          // Find current cell's row in the DOM
                          const sel = window.getSelection();
                  ...
                  <div className="flex flex-wrap gap-1">
                    {[
                      ...
                      <button
                        ...
                        onMouseDown={(e) => {
                          e.preventDefault();
                          // Find current cell and its column index
                          const sel = window.getSelection();
                          const anchor = sel?.anchorNode;
      ...
      {/* ── Editor area ── */}
      <div className="border border-t-0 rounded-b-lg px-4 py-3 min-h-100">
