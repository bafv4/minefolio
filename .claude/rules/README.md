...
- [general.md](./general.md) — コーディング規約（import順・命名・エクスポート・Loader/Action・エラー処理・翻訳・DBクエリ・プライバシーポリシー/利用規約への準拠）
- [ui.md](./ui.md) — UIデザイン規約（shadcn/ui 選定・テーマトークン・カラー・角丸/カードシステム/空状態/公開一覧ページヘッダ・タブ/ダイアログ/トーストの既定構造）
